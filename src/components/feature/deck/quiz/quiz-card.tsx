...
export const QuizCard = ({ card, className, show }: QuizCardProps) => {
  ...
  return (
    <div
      className={cn(
        'border border-foreground/30 rounded-sm shadow-xs max-w-3xl w-full px-4 py-6 pb-10',
    ...
    >
      ...
      <span
        ...
        border border-foreground/20 border-opacity-10 rounded-sm shadow-xs -z-10
      ...
      <span
        ...
        border border-foreground/20 border-opacity-20 rounded-sm shadow-xs -z-10
      ...
      <span
        ...
        border border-foreground/20 border-opacity-30 rounded-sm shadow-xs -z-10
